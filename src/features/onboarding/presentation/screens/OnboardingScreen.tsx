...
import { OnboardingStep } from '../../domain/entities/onboarding_step.entity';
...
export const OnboardingScreen = () => {
    ...
    const handleFinish = async () => {
        ...
        // Navigation will be handled by RootNavigator observing onboarding store or context
        // Actually, RootNavigator current implementation relies on its own state. 
        // We will update RootNavigator to use the store.
    };
