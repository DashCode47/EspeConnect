...
import { Plan, PlanCategory, PlanStatus } from '../../domain/entities/plan.entity';
        ...
        <View style={styles.cardHeader}>
          ...
          <View style={styles.cardHeaderInfo}>
            ...
            <View style={styles.cardMeta}>
              ...
              <Text style={styles.cardMetaText}>{formatTime(plan.startTime)}</Text>
            </View>
          </View>
        ...
        <View style={styles.cardInfoRow}>
          {plan.locationName && (
            <View style={styles.infoChip}>
              ...
              <Text style={styles.infoChipText} numberOfLines={1}>{plan.locationName}</Text>
            </View>
          )}
          <View style={styles.infoChip}>
            <MaterialCommunityIcons name="account-group" size={14} color="#6B7280" />
            <Text style={styles.infoChipText}>
              {plan.participantsCount || 0}{plan.maxParticipants ? `/${plan.maxParticipants}` : ''}
            </Text>
          </View>
        </View>
